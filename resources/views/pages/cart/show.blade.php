                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    <td class="text-center pe-0"><span class="fw-bold">{{ $group['raffle_id'] }}</span>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="symbol symbol-50px">
                                                <span class="symbol-label"
                                                    style="background-image:url({{ asset('assets/media/products') }}/{{ $group['raffle_image'] }});"></span>
                                            </a>
                                            <div class="ms-5">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="2"><strong>R$ {{ number_format($cartItemsGrouped->sum('total_price'), 2, ',', '.') }}</strong></td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        @else
                        <div class="d-flex justify-content-between mt-4">
                            <h3>Você ainda não possui itens no seu carrinho!</h3>
                        </div>
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('home') }}" class="btn btn-warning">Comprar</a>
                            </div>
                        @endif
                    </div>
                </div>
