            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('login') }}" id="kt_sign_in_form" data-kt-redirect-url="{{ route('home') }}" novalidate="novalidate">
                            @csrf
                            <!--begin::Heading-->
                            ...
                            <div class="fv-row mb-3">
                                <input id="password" type="password" placeholder="Senha" name="password" autocomplete="off" class="form-control bg-transparent" value="{{ old('password') }}"/>
                            </div>
                            <!--end::Input group=-->
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <!--begin::Link-->
                                <a href="{{ route('password.request') }}" class="link-warning">Esqueceu a senha?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Submit button-->
                            ...
                            <a href="{{ route('register') }}" class="link-warning">Registrar</a></div>
                            <!--end::Sign up-->
                        </form>
                        <!--end::Form-->
                    </div>
